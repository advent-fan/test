...
def generate_launch_description():
    ...
    hik_camera_node_first = get_camera_node('mindvision_camera', 'mindvision_camera::MVCameraNode', 'mv_camera_node')
    hik_camera_node_second = get_camera_node('mindvision_camera_1', 'mindvision_camera::MVCameraNode', 'mv_camera_node_1')
